...
public class CrearEditarEstudiante : AppCompatActivity() {
        ...
        when (modo) {
            "crear" -> {
                ...
                btnGuardar.setOnClickListener {
                    DatabaseHelper(this).crearEstudiante(
                        Estudiante(
                            0,
            ...
            "editar" -> {
                ...
                loadEstudiante(id)
                btnGuardar.setOnClickListener {
                    DatabaseHelper(this).updateEstudiante(
                        Estudiante(
                            id,
                            etEstudianteNombre.text.toString(),
                            etEstudianteApellido.text.toString(),
    ...
    fun loadEstudiante(id: Int) {
        val estudiante = DatabaseHelper(this).readEstudiante(id)
